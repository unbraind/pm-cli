{
  "id": "pm-tl4d",
  "title": "Track GitHub Dependabot alert #11 for undici (GHSA-9qxr-qj54-h672)",
  "description": "Undici's fetch with integrity option is too lax when algorithm is specified but hash value is in incorrect",
  "type": "Issue",
  "status": "closed",
  "priority": 2,
  "tags": [
  ...
  "created_at": "2026-03-12T22:34:28.698Z",
  "updated_at": "2026-03-12T23:19:33.852Z",
  "author": "codex-agent",
  ...
  "repro_steps": "Open https://github.com/unbraind/pm-cli/security/dependabot/11",
  "expected_result": "No open GitHub Dependabot alert remains for GHSA-9qxr-qj54-h672.",
  "actual_result": "GitHub reports open alert #11 for undici affecting < 5.28.4.",
  ...
  "comments": [
    {
      "created_at": "2026-03-12T22:34:28.698Z",
      "author": "codex-agent",
      "text": "Imported GitHub Dependabot alert GHSA-9qxr-qj54-h672."
    },
    {
      "created_at": "2026-03-12T23:19:33.007Z",
      "author": "cursor-agent",
...
GitHub Dependabot alert #11
Package: undici
GHSA: GHSA-9qxr-qj54-h672
CVE: CVE-2024-30261
Severity: low
...
Alert URL: https://github.com/unbraind/pm-cli/security/dependabot/11
