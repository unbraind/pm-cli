{
  "id": "pm-v6vi",
  "title": "Track GitHub Dependabot alert #8 for undici (GHSA-wqq4-5wpv-mx2g)",
  "description": "Undici's cookie header not cleared on cross-origin redirect in fetch",
  "type": "Issue",
  "status": "closed",
  "priority": 2,
  "tags": [
  ...
  "created_at": "2026-03-12T22:34:26.223Z",
  "updated_at": "2026-03-12T23:19:38.553Z",
  "author": "codex-agent",
  ...
  "repro_steps": "Open https://github.com/unbraind/pm-cli/security/dependabot/8",
  "expected_result": "No open GitHub Dependabot alert remains for GHSA-wqq4-5wpv-mx2g.",
  "actual_result": "GitHub reports open alert #8 for undici affecting < 5.26.2.",
  "affected_version": "< 5.26.2",
  "fixed_version": "5.26.2",
  ...
  "comments": [
    {
      "created_at": "2026-03-12T22:34:26.223Z",
      "author": "codex-agent",
      "text": "Imported GitHub Dependabot alert GHSA-wqq4-5wpv-mx2g."
    },
    {
      "created_at": "2026-03-12T23:19:37.770Z",
      "author": "cursor-agent",
...
Scope: runtime
Relationship: direct
Vulnerable range: < 5.26.2
First patched version: 5.26.2
Alert URL: https://github.com/unbraind/pm-cli/security/dependabot/8
