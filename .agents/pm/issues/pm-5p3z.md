{
  "id": "pm-5p3z",
  "title": "Track GitHub Dependabot alert #2 for undici (GHSA-q768-x9m6-m9qp)",
  "description": "undici before v5.8.0 vulnerable to uncleared cookies on cross-host / cross-origin redirect",
  "type": "Issue",
  "status": "closed",
  "priority": 2,
  "tags": [
  ...
  "created_at": "2026-03-12T22:34:21.376Z",
  "updated_at": "2026-03-12T23:19:40.140Z",
  "author": "codex-agent",
  ...
  "repro_steps": "Open https://github.com/unbraind/pm-cli/security/dependabot/2",
  "expected_result": "No open GitHub Dependabot alert remains for GHSA-q768-x9m6-m9qp.",
  "actual_result": "GitHub reports open alert #2 for undici affecting < 5.8.0.",
  ...
  "comments": [
    {
      "created_at": "2026-03-12T22:34:21.376Z",
      "author": "codex-agent",
      "text": "Imported GitHub Dependabot alert GHSA-q768-x9m6-m9qp."
    },
    {
      "created_at": "2026-03-12T23:19:39.337Z",
      "author": "cursor-agent",
...
GitHub Dependabot alert #2
Package: undici
GHSA: GHSA-q768-x9m6-m9qp
CVE: CVE-2022-31151
Severity: low
...
Alert URL: https://github.com/unbraind/pm-cli/security/dependabot/2
