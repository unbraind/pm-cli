{
  "id": "pm-bv2c",
  "title": "Track GitHub Dependabot alert #3 for undici (GHSA-8qr4-xgw6-wmr3)",
  "description": "`undici.request` vulnerable to SSRF using absolute URL on `pathname`",
  "type": "Issue",
  "status": "closed",
  "priority": 1,
  "tags": [
  ...
  "created_at": "2026-03-12T22:34:22.202Z",
  "updated_at": "2026-03-12T23:19:29.057Z",
  "author": "codex-agent",
  ...
  "repro_steps": "Open https://github.com/unbraind/pm-cli/security/dependabot/3",
  "expected_result": "No open GitHub Dependabot alert remains for GHSA-8qr4-xgw6-wmr3.",
  "actual_result": "GitHub reports open alert #3 for undici affecting <= 5.8.1.",
  "affected_version": "<= 5.8.1",
  "fixed_version": "5.8.2",
  ...
  "comments": [
    {
      "created_at": "2026-03-12T22:34:22.202Z",
      "author": "codex-agent",
      "text": "Imported GitHub Dependabot alert GHSA-8qr4-xgw6-wmr3."
    },
    {
      "created_at": "2026-03-12T23:19:28.257Z",
      "author": "cursor-agent",
...
GitHub Dependabot alert #3
Package: undici
GHSA: GHSA-8qr4-xgw6-wmr3
CVE: CVE-2022-35949
Severity: medium
Manifest: package.json
Scope: runtime
Relationship: direct
Vulnerable range: <= 5.8.1
First patched version: 5.8.2
Alert URL: https://github.com/unbraind/pm-cli/security/dependabot/3
