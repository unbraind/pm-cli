...
- MCP tool surface is a static snapshot: blind to runtime workspace schema and extension commands, and custom fields are unreachable through it ([pm-m4ikkz](https://github.com/unbraind/pm-cli/blob/main/.agents/pm/features/pm-m4ikkz.toon))
