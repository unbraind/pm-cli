...
- The CLI owns 87 usage refusals the SDK does not, and where one rule exists on both sides they refuse the same input with different codes ([pm-0xmajx](https://github.com/unbraind/pm-cli/blob/main/.agents/pm/issues/pm-0xmajx.toon))
