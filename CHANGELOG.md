...
- Linked-test regular-file capture still aborts high-volume Vitest output with UNKNOWN synchronous write failure ([pm-giks4s](https://github.com/unbraind/pm-cli/blob/main/.agents/pm/issues/pm-giks4s.toon))
