...
- `pm aggregate` provides grouped child-count projections (default `--group-by parent,type`; `--count` accepted for explicit parity) for governance decomposition checks.
