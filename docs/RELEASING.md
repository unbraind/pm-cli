...
- `CHANGELOG.pm.md` is generated by the installed `pm-changelog` package (`pm changelog generate`) from closed tracker items and checked in CI; do not edit it by hand
...
3. tracker changelog refresh through `pm changelog generate`
