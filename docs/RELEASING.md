...
- release reliability gating requires `SENTRY_PERSONAL_ADMIN_TOKEN` for issue-threshold checks; sourcemap upload is the optional Sentry step, and local maintainers should keep raw private reliability details in ignored local notes
