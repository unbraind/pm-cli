...
import { _testOnlyGetCommand, runGet } from "../../../../src/cli/commands/query/get.js";
import { runHistoryCompact } from "../../../../src/cli/commands/history/history-compact.js";
...
function createTask(
  ...
  const linkArgs = params.includeLinks
    ? [
        "--file",
        "path=src/cli/commands/query/get.ts,scope=project,note=get-link",
        "--test",
