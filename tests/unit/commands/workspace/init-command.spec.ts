...
import type * as InitModule from "../../../../src/cli/commands/workspace/init.js";
import type * as GuidanceModule from "../../../../src/sdk/init-agent-guidance.js";
...
describe("runInit", () => {
    ...
    try {
      {
        ...
        try {
          const mockedModule = await vi.importActual<typeof GuidanceModule>(
            "../../../../src/sdk/init-agent-guidance.js",
          );
  ...
  it("fails init --with-packages when bundled installs report unsuccessful entries", async () => {
    ...
    try {
      const initModule = await vi.importActual<typeof InitModule>(
        "../../../../src/cli/commands/workspace/init.js",
      );
      const tempRoot = await mkdtemp(
  ...
  it("deduplicates guidance next steps that already exist in init output", async () => {
    ...
    vi.doMock("../../../../src/sdk/init-agent-guidance.js", async () => {
    ...
    try {
      ...
      vi.doUnmock("../../../../src/sdk/init-agent-guidance.js");
      vi.resetModules();
    }
  });
