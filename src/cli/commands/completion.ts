...
${zshSearchRuntimeFieldFlags}            '--json[Output JSON]' \\
        ...
        extension)
          _arguments \\
            ...
            '--capability[Capability the init scaffold targets]:capability:(commands hooks search)' \\
...
complete -c pm -n '__fish_seen_subcommand_from extension' -l capability -d 'Capability the init scaffold targets' -r -a 'commands hooks search'
