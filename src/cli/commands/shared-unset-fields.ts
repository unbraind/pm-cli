...
/**
 * Describes an extension runtime field that can be removed from item front matter.
 */
...
/**
 * Resolve an unset token against runtime field definitions shared by create and update.
 */
