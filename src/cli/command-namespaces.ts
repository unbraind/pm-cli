...
import { PM_CONTEXT_OPS_COMMAND_ALIASES } from "../sdk/cli-contracts/command-aliases.js";
...
export function installCommandNamespaces(program: Command): void {
  ...
  for (const { alias, canonical_argv: [noun, verb] } of PM_CONTEXT_OPS_COMMAND_ALIASES) {
