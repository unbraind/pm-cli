...
> = {
  ...
  release: ["fullChangedFields", "idOnly"],
  "start-task": ["fullChangedFields", "idOnly"],
  "pause-task": ["fullChangedFields", "idOnly"],
  "close-task": ["fullChangedFields", "idOnly"],
...
const PM_TOOL_ACTION_SCHEMA_CONTRACTS: Record<string, PmActionSchemaContract> =
  {
    ...
    "history-repair": {
      ...
      mutuallyExclusiveWhen: [
        [
          { property: "salvageTail", schema: { const: true } },
          { property: "all", schema: { const: true } },
        ],
        [
          { property: "salvageTail", schema: { const: true } },
          { property: "normalizeProvenance", schema: { const: true } },
        ],
      ],
    },
    ...
    duplicates: {
      optional: ["status", "since", "threshold", "limit", "exhaustive"],
    },
    health: {
      optional: [
        "strictDirectories",
    ...
    assurance: {
      ...
      conditionalRequired: [
        ...
        { property: "subcommand", value: "risk", required: ["definition"] },
        { property: "subcommand", value: "lineages", required: ["definition"] },
        {
          property: "subcommand",
          value: "promote",
