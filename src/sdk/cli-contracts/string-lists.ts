...
/**
 * Returns the unique, trimmed, non-empty members of `values` in first-seen
 * order. Each value is trimmed before deduplication so accidental surrounding
 * whitespace cannot leak into — or produce duplicate — flag aliases and MCP
