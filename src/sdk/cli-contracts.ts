...
const ITEM_METADATA_MISSING_FILTER_FLAG_CONTRACTS: CliFlagContract[] = [
...
const ITEM_CONTENT_PRESENCE_FLAG_CONTRACTS: CliFlagContract[] = [
  { flag: "--has-notes" },
  { flag: "--no-notes" },
  { flag: "--has-learnings" },
  { flag: "--no-learnings" },
...
export const LIST_FILTER_FLAG_CONTRACTS: CliFlagContract[] = [
  ...
  ...ITEM_METADATA_MISSING_FILTER_FLAG_CONTRACTS,
  ...ITEM_CONTENT_PRESENCE_FLAG_CONTRACTS,
  { flag: "--limit" },
  { flag: "--offset" },
