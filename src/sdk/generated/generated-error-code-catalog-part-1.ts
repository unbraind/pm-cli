...
export const PM_ERROR_CODE_CATALOG_PART_1: PmErrorCodeContract[] = [
  ...
  },
  {
    ...
    meaning: "History baseline unavailable condition.",
    stability: "provisional",
    exit_code: 1,
    class: "generic_failure",
    recovery:
    ...
    emitting_commands: ["*"],
    canonical_code: "history_baseline_unavailable",
    aliases: [],
  },
  {
  ...
  },
  {
    ...
    meaning: "History json invalid condition.",
    stability: "provisional",
    exit_code: 1,
    class: "generic_failure",
    recovery:
    ...
    emitting_commands: ["*"],
    canonical_code: "history_json_invalid",
    aliases: [],
  },
  {
  ...
  },
  {
    ...
    meaning: "History replay invalid condition.",
    stability: "provisional",
    exit_code: 1,
    class: "generic_failure",
    recovery:
  ...
  },
  {
    ...
    meaning: "History salvage refused condition.",
    stability: "provisional",
    exit_code: 4,
    class: "conflict",
    recovery:
      "Inspect the structured error guidance and retry the suggested command.",
    sources: ["sdk/history/salvage.ts"],
    emitting_commands: ["*"],
    canonical_code: "history_salvage_refused",
    aliases: [],
  },
  {
  ...
  },
  {
    ...
    meaning: "History version mapping unavailable condition.",
    stability: "provisional",
    exit_code: 2,
    class: "usage",
    recovery:
      "Inspect the structured error guidance and retry the suggested command.",
    sources: ["core/history/version-address.ts"],
    emitting_commands: ["*"],
    canonical_code: "history_version_mapping_unavailable",
    aliases: [],
  },
  {
    code: "history_version_pruned",
    meaning: "History version pruned condition.",
    stability: "provisional",
    exit_code: 2,
    class: "usage",
    recovery:
    ...
    sources: ["core/history/projection.ts"],
    emitting_commands: ["*"],
    canonical_code: "history_version_pruned",
    aliases: [],
  },
  {
  ...
  },
  {
    ...
    emitting_commands: ["*"],
    canonical_code: "item_document_encoding_invalid",
    aliases: [],
  },
  {
  ...
  },
  {
    ...
    recovery:
      "Inspect the structured error guidance and retry the suggested command.",
    sources: ["core/history/history.ts"],
    emitting_commands: ["*"],
    canonical_code: "item_identity_reserved",
    aliases: [],
  },
  {
    code: "item_not_found",
