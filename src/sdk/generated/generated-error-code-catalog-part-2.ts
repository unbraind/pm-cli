...
export const PM_ERROR_CODE_CATALOG_PART_2: PmErrorCodeContract[] = [
  ...
  },
  {
    ...
    meaning: "Workflow policy approval history invalid condition.",
    stability: "provisional",
    exit_code: 4,
    class: "conflict",
    recovery:
  ...
  },
  {
    ...
    meaning: "Workflow policy input unreadable condition.",
    stability: "provisional",
    exit_code: 4,
    class: "conflict",
    recovery:
    ...
    sources: ["core/policy/workflow-policy-store.ts"],
    emitting_commands: ["*"],
    canonical_code: "workflow_policy_input_unreadable",
    aliases: [],
  },
  {
    code: "workflow_policy_invalid",
    meaning: "Workflow policy invalid condition.",
    stability: "provisional",
    exit_code: 2,
    class: "usage",
    recovery:
      "Inspect the structured error guidance and retry the suggested command.",
    sources: ["core/policy/workflow-policy.ts"],
    emitting_commands: ["*"],
    canonical_code: "workflow_policy_invalid",
    aliases: [],
  },
  {
    code: "workflow_policy_refused",
    meaning: "Workflow policy refused condition.",
    stability: "provisional",
    exit_code: 4,
    class: "conflict",
    recovery:
    ...
    sources: ["core/policy/workflow-policy-store.ts"],
    emitting_commands: ["*"],
    canonical_code: "workflow_policy_refused",
    aliases: [],
  },
  {
    code: "workflow_policy_registry_invalid",
    meaning: "Workflow policy registry invalid condition.",
    stability: "provisional",
    exit_code: 4,
    class: "conflict",
    recovery:
    ...
    sources: ["core/policy/workflow-policy-store.ts"],
    emitting_commands: ["*"],
    canonical_code: "workflow_policy_registry_invalid",
    aliases: [],
  },
  {
