  ...
  const result = await runAnnotationCommand<"notes", LogNote>(
    ...
    global,
    {
      ...
      conflictGuidance: {
        ...
        nextSteps: [
          "For an approved append without reassignment: pm package install governance-audit --project; then pm notes --help lists the package-owned append bypass. Edit/delete still require ownership.",
