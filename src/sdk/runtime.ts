...
export class PmClient {
   ...
   */
  append(id: string, body: string, options: PmClientMutationOptions = {}): Promise<AppendResult> {
    return this.runTyped("append", { id, ...splitClientMutationOptions({ ...options, body }) });
  }
