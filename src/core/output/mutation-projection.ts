...
function compactChangedFields(value: unknown): unknown {
  ...
  let changed = false;
  // Preserve the source prototype so a null-prototype object is not silently
  // re-parented to Object.prototype during compaction. isPlainObject guarantees the
  // prototype is null or Object.prototype, so a plain {} suffices for the common case.
  const projected: Record<string, unknown> = Object.getPrototypeOf(value) === null ? Object.create(null) : {};
